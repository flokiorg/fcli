...
func DeriveKeysFromXpub(network *chaincfg.Params, xpriv, xpub string, childIndex uint32) error {
	...
	log.Printf("Derived public key (index %d): %s", childIndex, add.EncodeAddress())
